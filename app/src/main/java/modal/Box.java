...
public class Box {
    ...
    public Box(int boxid, long today, String city, int cityid, int boxlistid, int routeorder, String name, String street, String insti, String genau, String exptime, String date, String date2, int status, int timing, float latitude, float longitude, int tourID) {
        this.boxid = boxid;
        this.today = today;
        this.city = city;
        this.cityid = cityid;
